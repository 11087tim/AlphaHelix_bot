...
def get_user_tweets(client: tweepy.Client, username: str, max_results: int = 10) -> list[dict]:
...
def search_recent(client: tweepy.Client, query: str, max_results: int = 10) -> list[dict]:
