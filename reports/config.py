...
def load_config(path: Path | None = None) -> ReportsConfig:
    ...
    return ReportsConfig(
        ...
        cheap_model=llm.get("cheap_model", "gpt-5.6-luna"),
        strong_model=llm.get("strong_model", "gpt-5.6-sol"),
        vision_model=llm.get("vision_model", "gpt-5.6-luna"),
        comment_model=llm.get("comment_model", "gpt-5.6-luna"),
