...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  details.day > summary { cursor:pointer; font-weight:700; font-size:1.2rem; padding:12px 0; list-style:none; }
  details.day > summary::before { content:"▸ "; color:var(--accent); }
  details.day[open] > summary::before { content:"▾ "; }
  h2 { font-size:1.35rem; margin:20px 0 8px; color:var(--accent); }
  h3 { font-size:1.15rem; margin:16px 0 6px; }
  h4 { font-size:1.05rem; margin:14px 0 4px; }
  .report { border-top:1px solid var(--line); margin-top:18px; padding-top:6px; }
  .report h2 { font-size:1.15rem; color:var(--fg); }
  ul { margin:6px 0 12px; padding-left:22px; }
  li { margin:2px 0; }
  hr { border:none; border-top:1px solid var(--line); margin:18px 0; }
  .foot { color:var(--muted); font-size:.8rem; margin-top:30px; }
  /* 大綱側欄（設計對齊主站 X digest）*/
  .toc { position:fixed; top:24px; left:24px; width:270px; max-height:calc(100vh - 48px);
    display:flex; flex-direction:column; overflow:hidden; background:var(--card);
    border:1px solid var(--line); border-radius:10px; padding:14px 16px; font-size:1rem;
    box-shadow:0 2px 8px rgba(0,0,0,.06); }
  .toc-title { font-weight:700; color:var(--accent); margin-bottom:8px; font-size:1.1rem; flex:0 0 auto; }
  ...
  .toc a.lv2 { padding-left:16px; color:var(--muted); font-size:.95rem; }
